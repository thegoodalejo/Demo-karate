@users @negativo
Feature: Obtener un usuario con identificador de formato inválido
  ...
  @id-invalido
  Scenario Outline: Intentar obtener un usuario con identificador <descripcion>
    Given path usersEndpoint + '/<id>'
    When method GET
    Then status <estado>
